  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" v-if="open" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="110px" :disabled="disabled">
        ...
        <el-form-item label="采购计划" prop="purchasePlan" v-if="form.urgent === 0">
        ...
        <el-form-item label="加急采购计划" prop="urgentPurchasePlan">
        ...
        <el-form-item label="提供物品" prop="provideItems">
          ...
          <el-input v-else v-model="form.provideItems" placeholder="请输入提供物品" />
        </el-form-item>

        <el-form-item label="产品验收" prop="productInspection" v-if="form.productInspection === 1">
        ...
        <el-form-item label="登记记录" prop="recordEntry" v-if="form.productInspection === 1">
          <div v-if="infoVo && Object.keys(infoVo).length">{{ form.recordEntry }}</div>
          <el-input v-else :disabled="true" v-model="form.recordEntry" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="退货" prop="returnItems" v-if="form.productInspection === 1">
          <div v-if="infoVo && Object.keys(infoVo).length">{{ form.returnItems }}</div>
          <el-input v-else :disabled="true" v-model="form.returnItems" placeholder="请输入退货" />
        </el-form-item>
