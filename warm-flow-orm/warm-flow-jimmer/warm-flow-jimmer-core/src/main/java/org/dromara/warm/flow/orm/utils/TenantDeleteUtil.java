...
/**
 * Applies Warm Flow tenant and logical-delete defaults before Jimmer queries/mutations.
 */
public final class TenantDeleteUtil {
    ...
    public static <T extends RootEntity> T getEntity(T entity) {
        ...
        if (flowConfig != null && flowConfig.isLogicDelete()) {
    ...
    public static boolean logicDeleteEnabled() {
        WarmFlow flowConfig = FlowEngine.getFlowConfig();
        return flowConfig != null && flowConfig.isLogicDelete();
    }

    public static String logicDeleteValue() {
        WarmFlow flowConfig = FlowEngine.getFlowConfig();
        return flowConfig == null ? "2" : flowConfig.getLogicDeleteValue();
    }
}
